      ...
      (a.onload = function () {
        ...
        n.attr("src", e.album[i].link),
          ...
          e.options.fitImagesInViewport &&
            ((d = t(window).width()),
            (l = t(window).height()),
            (r = d - e.containerLeftPadding - e.containerRightPadding - 20),
            (h = l - e.containerTopPadding - e.containerBottomPadding - 120),
            e.options.maxWidth &&
              e.options.maxWidth < r &&
              (r = e.options.maxWidth),
            e.options.maxHeight &&
              e.options.maxHeight < r &&
              (h = e.options.maxHeight),
            (a.width > r || a.height > h) &&
              (a.width / r > a.height / h
                ? ((s = r),
                  (o = parseInt(a.height / (a.width / s), 10)),
                  n.width(s),
                  n.height(o))
                : ((o = h),
                  (s = parseInt(a.width / (a.height / o), 10)),
                  n.width(s),
                  n.height(o)))),
          e.sizeContainer(n.width(), n.height());
      }),
        (a.src = this.album[i].link),
