  ...
  (function (t, i, s) {
    var e = {
      ...
      loadContent: function () {
        var i,
          s = this;
        "function" == typeof s.options.beforeInit &&
          s.options.beforeInit.apply(this, [s.$elem]),
          "string" == typeof s.options.jsonPath
            ? ((i = s.options.jsonPath),
      ...
      response: function () {
        ...
        (e = t(i).width()),
          (o.resizer = function () {
            t(i).width() !== e &&
              (!1 !== o.options.autoPlay && i.clearInterval(o.autoPlayInterval),
              i.clearTimeout(s),
      ...
      max: function () {
        ...
        return (
          this.options.items > this.itemsAmount
            ? ((this.maximumItem = 0), (t = 0), (this.maximumPixels = 0))
        ...
        for (
          ...
          (o += this.itemWidth),
            ...
            !0 === this.options.scrollPerPage &&
              (s = t(this.$owlItems[i]).data("owl-roundPages")) !== e &&
      ...
      checkBrowser: function () {
        ...
        (r.style.cssText =
          ...
          (o = null !== (e = r.style.cssText.match(t)) && 1 === e.length),
          (n = "ontouchstart" in i || i.navigator.msMaxTouchPoints),
          (this.browser = { support3d: o, isTouch: n });
      },
      moveEvents: function () {
      ...
      gestures: function () {
        ...
        function a(i) {
          "on" === i
            ? (t(s).on(e.ev_types.move, r), t(s).on(e.ev_types.end, l))
            : "off" === i &&
              (t(s).off(e.ev_types.move), t(s).off(e.ev_types.end));
        }
        function r(a) {
          var r,
            l,
            h = a.originalEvent || a || i.event;
          (e.newPosX = n(h).x - o.offsetX),
            (e.newPosY = n(h).y - o.offsetY),
            (e.newRelativeX = e.newPosX - o.relativePos),
            "function" == typeof e.options.startDragging &&
              !0 !== o.dragging &&
              0 !== e.newRelativeX &&
              ((o.dragging = !0), e.options.startDragging.apply(e, [e.$elem])),
            (e.newRelativeX > 8 || e.newRelativeX < -8) &&
              !0 === e.browser.isTouch &&
              (void 0 !== h.preventDefault
                ? h.preventDefault()
                : (h.returnValue = !1),
              (o.sliding = !0)),
            (e.newPosY > 10 || e.newPosY < -10) &&
              !1 === o.sliding &&
              t(s).off("touchmove.owl"),
            (r = function () {
              return e.newRelativeX / 5;
            }),
            (l = function () {
              return e.maximumPixels + e.newRelativeX / 5;
            }),
            (e.newPosX = Math.max(Math.min(e.newPosX, r()), l())),
            !0 === e.browser.support3d
              ? e.transition3d(e.newPosX)
              : e.css2move(e.newPosX);
        }
        function l(s) {
          var n,
            r,
            l,
            h = s.originalEvent || s || i.event;
          (h.target = h.target || h.srcElement),
            (o.dragging = !1),
            !0 !== e.browser.isTouch && e.$owlWrapper.removeClass("grabbing"),
            e.newRelativeX < 0
              ? (e.dragDirection = e.owl.dragDirection = "left")
              : (e.dragDirection = e.owl.dragDirection = "right"),
            0 !== e.newRelativeX &&
              ((n = e.getNewPosition()),
              e.goTo(n, !1, "drag"),
              o.targetElement === h.target &&
                !0 !== e.browser.isTouch &&
                (t(h.target).on("click.disable", function (i) {
                  i.stopImmediatePropagation(),
                    i.stopPropagation(),
                    i.preventDefault(),
                    t(i.target).off("click.disable");
                }),
                (l = (r = t._data(h.target, "events").click).pop()),
                r.splice(0, 0, l))),
            a("off");
        }
        (e.isCssFinish = !0),
          e.$elem.on(e.ev_types.start, ".owl-wrapper", function (s) {
            var r,
              l = s.originalEvent || s || i.event;
            if (3 === l.which) return !1;
            if (!(e.itemsAmount <= e.options.items)) {
              if (!1 === e.isCssFinish && !e.options.dragBeforeAnimFinish)
                return !1;
              if (!1 === e.isCss3Finish && !e.options.dragBeforeAnimFinish)
                return !1;
              !1 !== e.options.autoPlay && i.clearInterval(e.autoPlayInterval),
                !0 === e.browser.isTouch ||
                  e.$owlWrapper.hasClass("grabbing") ||
                  e.$owlWrapper.addClass("grabbing"),
                (e.newPosX = 0),
                (e.newRelativeX = 0),
                t(this).css(e.removeTransition()),
                (r = t(this).position()),
                (o.relativePos = r.left),
                (o.offsetX = n(l).x - r.left),
                (o.offsetY = n(l).y - r.top),
                a("on"),
                (o.sliding = !1),
      ...
      lazyLoad: function () {
        ...
        for (i = 0; i < this.itemsAmount; i += 1)
          "loaded" !== (s = t(this.$owlItems[i])).data("owl-loaded") &&
            ((e = s.data("owl-item")),
            "string" == typeof (o = s.find(".lazyOwl")).data("src")
              ? (void 0 === s.data("owl-loaded") &&
                  (o.hide(),
                  s.addClass("loading").data("owl-loaded", "checked")),
                (!0 !== this.options.lazyFollow || e >= this.currentItem) &&
      ...
      lazyPreload: function (t, s) {
        ...
        function a() {
          t.data("owl-loaded", "loaded").removeClass("loading"),
            ...
            "fade" === o.options.lazyEffect ? s.fadeIn(400) : s.show(),
            "function" == typeof o.options.afterLazyLoad &&
              o.options.afterLazyLoad.apply(this, [o.$elem]);
        }
        "DIV" === s.prop("tagName")
          ? (s.css("background-image", "url(" + s.data("src") + ")"), (e = !0))
          : (s[0].src = s.data("src")),
          (function t() {
            (n += 1),
              o.completeImg(s.get(0)) || !0 === e
                ? a()
                : n <= 100
                ? i.setTimeout(t, 100)
                : a();
      ...
      autoHeight: function () {
        ...
        function n() {
          ...
          e.wrapperOuter.css("height", s + "px"),
      ...
      singleItemTransition: function () {
        ...
        (t.isTransition = !0),
          ...
          e.addClass(s).on(r, function () {
            (t.endCurrent = !0), e.off(r), t.clearTransStyle(e, s);
          });
      },
